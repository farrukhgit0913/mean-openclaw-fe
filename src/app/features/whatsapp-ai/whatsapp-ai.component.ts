...
@Component({
  selector: 'app-whatsapp-ai',
  imports: [
    FormsModule
  ],
  templateUrl: './whatsapp-ai.component.html',
  styleUrl: './whatsapp-ai.component.scss'
})
export class WhatsappAiComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Enable this if you want Angular
    // to receive real-time WhatsApp messages.
